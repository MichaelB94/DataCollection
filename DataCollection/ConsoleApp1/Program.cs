...
void Push()
{
    Console.Write("Enter a string to push: ");
    string item = Console.ReadLine();
    myStack.Push(item);
...
void Pop()
{
    if (myStack.Count > 0)
    {
        ...
        Console.WriteLine($"Pop item: {popItem}");
    }
    else
    {
        Console.WriteLine("Stack is empty. No items to pop.");
    }
}
...
void Peek()
{
    if (myStack.Count > 0)
    {
        string peekedItem = (string)myStack.Peek();
        Console.WriteLine($"Peeked item: {peekedItem}");
    }
    else
    {
        Console.WriteLine("Stack is empty. No items to peek.");
    }
}
